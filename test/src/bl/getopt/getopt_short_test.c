...
static void getopt_short_empty (void **state)
{
  ...
  char* argv[] = {"foo.exe"};
  assert_true (-1 == bl_getopt (&s, bl_arr_elems (argv), argv, "abc"));
}
/*---------------------------------------------------------------------------*/
static void getopt_short_simple (void **state)
{
  bl_getopt_state s = BL_GETOPT_STATE_INITIALIZER;
  char* argv[] = {"foo.exe", "-a"};
  assert_true ('a' == bl_getopt (&s, bl_arr_elems (argv), argv, "a"));
}
/*---------------------------------------------------------------------------*/
static void getopt_short_unrecognized (void **state)
{
  bl_getopt_state s = BL_GETOPT_STATE_INITIALIZER;
  char* argv[] = {"foo.exe", "-a"};
  assert_true ('?' == bl_getopt (&s, bl_arr_elems (argv), argv, "cde"));
}
/*---------------------------------------------------------------------------*/
static void getopt_short_only_nonoptions (void **state)
{
  ...
  assert_true (-1 == bl_getopt (&s, bl_arr_elems (argv), argv, "cde"));
}
/*---------------------------------------------------------------------------*/
static void getopt_short_consume_subset (void **state)
{
  ...
  assert_true ('f' == bl_getopt (&s, bl_arr_elems (argv), argv, "fgh"));
  assert_true ('g' == bl_getopt (&s, bl_arr_elems (argv), argv, "fgh"));
}
/*---------------------------------------------------------------------------*/
static void getopt_short_multiple_options_diff_argv (void **state)
{
  ...
  assert_true ('b' == bl_getopt (&s, bl_arr_elems (argv), argv, "ab"));
  assert_true ('a' == bl_getopt (&s, bl_arr_elems (argv), argv, "ab"));
}
/*---------------------------------------------------------------------------*/
...
static void getopt_short_embedded_nonoptions (void **state)
{
  ...
  assert_true (-1 == bl_getopt (&s, bl_arr_elems (argv), argv, "ab"));
}
/*---------------------------------------------------------------------------*/
...
static void getopt_short_required_arg_missing (void **state)
{
  bl_getopt_state s = BL_GETOPT_STATE_INITIALIZER;
  char* argv[] = {"foo.exe", "-a"};
  assert_true ('?' == bl_getopt (&s, bl_arr_elems (argv), argv, "a:"));
