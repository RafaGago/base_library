...
scripts/autogenerator.sh -f source-generation/timestamp_funcs_microsecond_base.gen.h -r BITS=32 -r BITS=
scripts/autogenerator.sh -f source-generation/timestamp_funcs_nanosecond_base.gen.h -r BITS=64 -r BITS=
