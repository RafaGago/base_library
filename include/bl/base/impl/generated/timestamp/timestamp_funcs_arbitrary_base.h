...
Don't edit.
*/
/* AUTOGENERATE: include/bl/base/impl/generated/timestamp/timestamp_funcs_arbitrary_base.h */
/*---------------------------------------------------------------------------*/
...
/*---------------------------------------------------------------------------*/
extern BL_EXPORT bl_toffset bl_tstamp_to_private(bl_tstamp ts, bl_u factor);
/*---------------------------------------------------------------------------*/
extern BL_EXPORT bl_toffset
  bl_tstamp_to_ceil_private (bl_tstamp ts, bl_u factor);
/*---------------------------------------------------------------------------*/
extern BL_EXPORT bl_tstamp
  bl_to_tstamp_private (bl_toffset amt, bl_u factor);
/*---------------------------------------------------------------------------*/
